...
// 粉牆上的字
{
  ...
  g.font = '900 300px "SF Pro Display", "Helvetica Neue", Arial, sans-serif';
  g.fillText('01', 90, 120);
  g.font = '700 96px "SF Pro Display", "Helvetica Neue", Arial, sans-serif';
  g.fillText('CatInsight', 96, 440);
  g.font = '500 58px "SF Pro Display", "Helvetica Neue", Arial, sans-serif';
  g.globalAlpha = 0.85;
  g.fillText('AI stock research', 100, 560);
